...
<form action="{{ route('admin_notice.update', ['id'=>$articles->id]) }}" method="POST">
@csrf
    ...
    @endif
            ...
            <textarea  class="form-control" name="article_contents" id="article_contents"></textarea>
        </dit>

        <button type="submit" class="btn btn-success" onclick= "return confirm('変更しますか？');">
                {{ __('変更') }}
            </button>  
        </form>
